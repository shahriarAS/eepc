...
function LetterDetailPage() {
    const { letterCategory } = useParams()
    const LetterData = useSelector(state => state.LetterData)[letterCategory]
