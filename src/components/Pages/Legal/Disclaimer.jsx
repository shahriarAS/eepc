    ...
    <div className="flex justify-center h-full pb-8 bg-gray-200">
      <div className="container py-8 w-2/4">
        <div className="my-4 flex flex-col justify-center items-center">
          <h1 className="text-3xl text-blue-500">Disclaimer</h1>
        </div>
        <div className="flex justify-center w-full">
          <p className="text-lg">
            ...
            <br/>
            <h2>Disclaimers for EEPC | Learn English With The Modern Way</h2>
            <br/>
            <p>
              All the information on this website - https://www.eepc.xyz/ - is
              published in good faith and for general information purpose only.
              EEPC | Learn English With The Modern Way does not make any
              ...
              find on this website (EEPC | Learn English With The Modern Way),
              is strictly at your own risk. EEPC | Learn English With The Modern
              Way will not be liable for any losses and/or damages in connection
