    ...
    <div className="flex justify-center h-full pb-8 bg-gray-200">
      <div className="container py-8 w-full px-4 md:px-0 md:w-2/4">
        ...
        <div className="flex justify-center w-full">
          <p className="text-lg">
            <p>
              At EEPC | Learn English With The Modern Way, accessible from
              https://www.eepc.xyz/, one of our main priorities is the privacy
              of our visitors. This Privacy Policy document contains types of
              information that is collected and recorded by EEPC | Learn English
              With The Modern Way and how we use it.
            </p>{" "}
            <br />
            <p>
            ...
            <p>
              ...
              that they shared and/or collect in EEPC | Learn English With The
              Modern Way. This policy is not applicable to any information
            ...
            <h2>Log Files</h2>
            <p>
              EEPC | Learn English With The Modern Way follows a standard
            ...
            <p>
              ...
              the advertising partners of EEPC | Learn English With The Modern
              Way.
            </p>{" "}
            <br />
            <p>
              ...
              respective advertisements and links that appear on EEPC | Learn
              English With The Modern Way, which are sent directly to users'
            ...
            <br />
            <p>
              Note that EEPC | Learn English With The Modern Way has no access
            ...
            <p>
              EEPC | Learn English With The Modern Way's Privacy Policy does not
            ...
            <br />
            <p>
              EEPC | Learn English With The Modern Way does not knowingly
