    ...
    return (
        <footer className="text-gray-600 body-font">
            <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                ...
                <p className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start items-center text-sm">Page Views: <img src="https://www.simple-counter.com/hit.php?id=zvvqkkk&nd=9&nc=4&bc=1" border="0" alt="Hit Counter" className="ml-2"/></p>
